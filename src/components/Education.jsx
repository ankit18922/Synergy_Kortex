          ...
          <div className="flex flex-col lg:flex-row items-start gap-16">
            ...
            >
              ...
              <motion.ul className="space-y-6">
                {[
                  "Track and manage all campus assets, from HVAC systems to classroom equipment, and create workflows for maintenance approvals and documentation.",
                  "Access comprehensive maintenance history and performance data to make informed decisions about asset replacement and upgrades.",
                  "Ensure compliance with educational facility standards and maintain detailed records for accreditation requirements."
                ].map((item, index) => (
                  <motion.li
                    key={index}
